        ...
        <ol className='flex flex-col md:flex-row relative border-l-2 border-stone-200'>
            <li className='mb-10 ml-4'>
                ...
                <p className='flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm'>
                    <span className='inline-block px-2 py-1 font-semibold text-white bg-[#162a18] rounded-md'>{year}</span>
                    <span className='text-lg font-semibold text-[#2e8035]'>{title}</span>
